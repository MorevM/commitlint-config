...
* [Create an issue](https://github.com/MorevM/commitlint-config/issues/new)
...
* [Задать вопрос / Сообщить о баге / Предложить новую функциональность](https://github.com/MorevM/commitlint-config/issues/new)
